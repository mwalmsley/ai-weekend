...
from aspect_lookup import all_aspects
...
# goes through the whole transcript, all the time
def listen_print_loop(responses):
    ...
    num_chars_printed = 0
    for response in responses:  # responses is generator, will never exit this loop
        ...
        #     # print interim results (i.e. while streaming)
...
def aspects_from_stream(message):
    ...
    with MicrophoneStream(RATE, CHUNK) as stream:
        ...
        aspects = listen_print_loop(responses)
